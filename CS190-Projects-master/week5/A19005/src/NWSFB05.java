...
public class NWSFB05 {
    ...
    public String strOutputFile = "doc\\FBOUT.txt";
    ...
    public String getAltitudeWeather(String strAlt) {
        ...
        //System.out.println(strStationWeather.length());
        String strRet = "";
    ...
    public String getWindDir(String strAlt) {
        ...
        //System.out.println(getAltitudeWeather(strAlt).substring(0, 2));
